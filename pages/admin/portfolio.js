...
const Blog = ({ Blogs }) => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            await axios.post(`${process.env.NEXT_PUBLIC_SITE_URL}/api/portfolios`, newBlogPost);
    ...
    const handleDelete = async (productID) => {
        try {
            const res = await axios.delete(
                `${process.env.NEXT_PUBLIC_SITE_URL}/api/portfolios/` + productID
            );
    ...
    const handleUpdate = async (postId) => {
        try {
            const res = await axios.get(`${process.env.NEXT_PUBLIC_SITE_URL}/api/portfolios/` + postId);
    ...
    const updateData = async (e) => {
        ...
        try {
            ...
            const { url } = uploadRes.data;
            await axios.put(`${process.env.NEXT_PUBLIC_SITE_URL}/api/portfolios/` + id, {
                title: updatedTitle,
...
export const getServerSideProps = async ({ req }) => {
    ...
    const blogRes = await axios.get(`${process.env.NEXT_PUBLIC_SITE_URL}/api/portfolios`);
