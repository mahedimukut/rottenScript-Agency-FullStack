...
const Blog = ({ Blogs }) => {
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            await axios.post(`${process.env.NEXT_PUBLIC_SITE_URL}/api/blogs`, newBlogPost);
    ...
    const handleDelete = async (productID) => {
        try {
            const res = await axios.delete(
                `${process.env.NEXT_PUBLIC_SITE_URL}/api/blogs/` + productID
            );
    ...
    const handleUpdate = async (postId) => {
        try {
            const res = await axios.get(`${process.env.NEXT_PUBLIC_SITE_URL}/api/blogs/` + postId);
    ...
    const updateData = async (e) => {
        ...
        try {
            ...
            const { url } = uploadRes.data;
            await axios.put(`${process.env.NEXT_PUBLIC_SITE_URL}/api/blogs/` + id, {
                title: updatedTitle,
                desc: updatedDesc,
                image_url: url
            });
...
export const getServerSideProps = async ({ req }) => {
    ...
    const blogRes = await axios.get(`${process.env.NEXT_PUBLIC_SITE_URL}/api/blogs`);
